module.exports = function(ctx) {
    ...
    var tsScriptPath = path.join(ctx.opts.projectRoot, 'plugins', 'cordova-ionic-smisdk-plugin', 'src', 'smi-sdk-cordova', 'index.js');
    ...
    tsScriptPath = path.join(ctx.opts.projectRoot, 'plugins', 'cordova-ionic-smisdk-plugin', 'src', 'smi-sdk-cordova', 'index.d.ts');
